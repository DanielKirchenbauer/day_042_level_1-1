...
import ShowAnswer from "../ShowAnswer/ShowAnswer.jsx";


const showLongAnswer = () => {
    ...
    const handleShowQuestion = (event) => {
        ...
        setShowAnswer((prevShowQuestion) => !prevShowQuestion);
    }
    ...
    const handleShowLongAnswer = (event) => {
        event.preventDefault();

        setShowLongAnswer((prevShowLongAnswer) => !prevShowLongAnswer);
    }
    ...
    <>
        <div>
            <ol> 
                {dataArray.map((faqArray) => (
                <li>
                    <p>{faqArray.answerLong}</p>
                </li>))}
            </ol>
        </div>
    </>
